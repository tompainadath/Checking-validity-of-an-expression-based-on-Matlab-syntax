...
# Program file : Matlab_Expression_Check.asm
...
.text 
 ...
 Continue:
       ...
       L2: 
          ...
          jal Print_no_error                       #jump and link to print 'valid input' message
  ...
  more_error_check:
          ...
          beq $t5, 0, double_error              #branch to print 'Invalid input' message if errors ' // ' and ' ** ' were found
  ...
  digit_before_space_check:
          sub $t5, $t4, $t2
          beq $t5, 16, space_tracker
          beq $t5, 17, space_tracker
          beq $t5, 18, space_tracker
          beq $t5, 19, space_tracker
          beq $t5, 20, space_tracker
          beq $t5, 21, space_tracker
          beq $t5, 22, space_tracker
          beq $t5, 23, space_tracker
          beq $t5, 24, space_tracker
          beq $t5, 25, space_tracker
          jal again
  ...
  space_tracker:
          addi $t8, $t8, 1
          beq $t8, 2, Print_error
          jal again
  double_error:
          beq $t2, 42, Print_error
          beq $t2, 47, Print_error
          jal again
  Print_error:
          add $a0, $zero, $zero
          li $v0, 4
